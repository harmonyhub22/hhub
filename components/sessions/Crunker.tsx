export interface CrunkerConstructorOptions {
  ...
  export default class Crunker {
    ...
    /**
     * Reverses a given buffer. Returns a new buffer
     *
     * @param buffer Buffer to be reversed
     * 
     */
    reverse(buffer: AudioBuffer){
      const ac = new AudioContext()
      const reverse = ac.createBuffer(buffer.numberOfChannels,buffer.length,buffer.sampleRate);
    ...
    // fadein(buffer:AudioBuffer,timetofadein: number){
